"""Download list Nifti files."""
from os import path as op
from subprocess import call

SAVE_PATH = op.join('om', 'user', 'jakubk', 'meningioma', 'data')
...
for fname, _ in [tuple(row.split(',')) for row in FILES.split()]:
    command = "wget {} -P {}".format(fname, SAVE_PATH)
    call(command.split(" "))
